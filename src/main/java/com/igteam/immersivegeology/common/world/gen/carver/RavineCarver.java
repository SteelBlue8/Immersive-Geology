...
public class RavineCarver extends CanyonWorldCarver {
    ...
    public RavineCarver(IWorld worldIn, Function<Dynamic<?>, ? extends ProbabilityConfig> p_i49930_1_) {
        super(p_i49930_1_);
        this.world = worldIn;
        this.liquidAltitude = 11;//This may need to be changed.
    }
    ...
    protected void carveRegion(IChunk chunkIn, long seed, int seaLevel, int originChunkX, int originChunkZ, double ravineStartX, double ravineStartY, double ravineStartZ, double xzOffset, double yOffset, BlockState[][] liquidBlocks, Map<Long, IGBiome> biomeMap, BitSet airCarvingMask, BitSet liquidCarvingMask) {
    ...
    private void carveBlock(IChunk chunkIn, Random rand, int seaLevel, BlockPos.MutableBlockPos blockPos, BlockState liquidBlockState, Map<Long, IGBiome> biomeMap, BitSet airCarvingMask, BitSet liquidCarvingMask) {
        ...
        if (flooded) {
            ...
            CarverUtils.carveBlockRavine(chunkIn, blockPos, liquidBlockState, this.liquidAltitude, true, true, airCarvingMask);
        }
    }
