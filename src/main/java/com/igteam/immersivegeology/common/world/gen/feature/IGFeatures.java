...
import com.igteam.immersivegeology.common.world.gen.feature.structure.ImmersiveVillageStructure;
...
public class IGFeatures<FC extends IFeatureConfig> extends ForgeRegistryEntry<Feature<?>> {
    ...
    public static final Feature<NoFeatureConfig> EBONY_TREES = new BeechTreeFeature(NoFeatureConfig::deserialize, true, true);
    ...
    public static final Structure<VillageConfig> IMMERSIVE_VILLAGE = (Structure)register("village", new ImmersiveVillageStructure(VillageConfig::deserialize));
